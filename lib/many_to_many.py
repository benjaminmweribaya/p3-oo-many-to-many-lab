class Author:
    ...
    def books(self):
        """Returns a list of books related to the author using contracts."""
        return [contract.book for contract in self.contracts()]

    def sign_contract(self, book, date, royalties):
        """Creates and returns a new Contract object for the author."""
        if not isinstance(book, Book):
            raise Exception("sign_contract expects an instance of Book.")
        return Contract(self, book, date, royalties)

    def total_royalties(self):
        """Calculates and returns the total royalties earned by the author."""
...
class Book:
    ...
    def authors(self):
        """Returns a list of authors related to the book using contracts."""
